        ...
        <div>
            ...
            <body class="text-[#fff] bg-[#000000]">
                <header className="flex h-[107px] justify-between items-center z-[100] fixed w-full py-5 px-12 bg-[#00000069] backdrop-filter backdrop-blur-[25px]">
                    ...
                    <div className="navabr block cursor-pointer absolute top-[30px] right-[40px] z-[2] m-0 lg:m-[10px]  lg:hidden ">
                        <div class="bar transition duration-[0.2s] mx-[10px] my-[15px] lg:m-[25px]" onClick={toggleNavbar}>
                            <span class={`bar-1 block w-[25px] border-solid border-t-[2px] border-[#C5f602] pt-[5px] trasition duration-[0.4s] cursor-pointer ${isOpen ? '-rotate-[45deg] translate-x-[4px] translate-y-[8px] w-[26px]' : ''} `}></span>
                            <span class={`bar-2 block w-[20px] border-t-[2px] border-solid border-[#C5f602] pt-[5px] trasition duration-[0.4s] ${isOpen ? 'rotate-[45deg] translate-x-[1px] translate-y-[1.5px] w-[26px] opacity-[1]' : ''}`}></span>
                            <span class={`bar-3 block w-[14px] border-t-[2px] border-solid border-[#C5f602] pt-[5px] trasition duration-[0.4s] ${isOpen ? 'rotate-[45deg] -translate-x-[14px] -translate-y-[9.8px] hidden' : ''}`}></span>
                        </div>
                    </div>
                    {isOpen && (
                        <div className="ham-burger w-[100%] bg-[#000000] z-[1] text-left top-[80px] right-0 left-0 absolute m-0 border-t-[1px] boder-solid border-[#292929] pl-[55px] rounded-br-[35px] rounded-bl-[35px] pt-[30px] shadow-[0px_100px_200px_10px] shadow-[#393939] lg:hidden block">
                ...
                <section class="boxed first-section flex justify-center items-center sm:h-[570px] md:h-[640px] lg:h-[700px] xl:h-[860px] 2xl:h-[996px] pt-[175px] relative" id="first-section">
                    <div class="flex justify-start items-center tag-one h-[100px] rotate-[10deg] rounded-tl-[15px] rounded-br-[4px] rounded-tr-[4px] rounded-bl-[15px] rounded-r-none min-w-[350px] p-[15px] min-h-[100px] absolute z-[5] 
                    before:content-[''] before:absolute before:min-w-[12px] before:min-h-[12px] before:boredr-solid before:border-[1px] before:border-[#D9D9D9] before:rounded-[50px] before:z-[3] before:bg-[#000000] before:-right-[15px]
                    after:content-[''] after:backdrop-blur-[25px] after:absolute after:min-w-[77px] after:min-h-[77px] after:-z-[1] after:-right-[35px] after:rotate-[45deg] after:rounded-t-[11px] after:rounded-r-[10px] after:rounded-b-[11px] after:rounded-l-[0px] after:bg-[#333821] after:border-r-solid after:border-r-[1px] after:border-r-[#C5F60166] after:border-t-solid after:border-t-[1px] after:border-t-[#C5F60166] 
                    sm:scale-[0.5] sm:top-[220px] sm:-left-[80px] md:scale-[0.7] md:top-[240px] md:-left-[40px] lg:left-[60px] lg:scale-[0.8] lg:top-[230px] xl:left-[100px] xl:top-[260px] xl:scale-[1] 2xl:left-[130px] 2xl:top-[300px]">
                    ...
                    <div class="flex justify-start items-center tag-two h-[86px] -rotate-[13deg] rounded-l-none rounded-tl-[4px] rounded-br-[15px] rounded-tr-[15px] rounded-bl-[4px] min-w-[350px] p-[15px] min-h-[100px] absolute z-[5] 
                    before:content-[''] before:absolute before:min-w-[12px] before:min-h-[12px] before:boredr-solid before:border-[1px] before:border-[#D9D9D9] before:rounded-[50px] before:z-[3] before:bg-[#000000] before:-right-[15px]
                    after:content-[''] after:backdrop-blur-[25px] after:absolute after:min-w-[77px] after:min-h-[77px] after:-z-[1] after:-right-[35px] after:rotate-[45deg] after:rounded-t-[11px] after:rounded-r-[10px] after:rounded-b-[11px] after:rounded-l-[0px] after:bg-[#333821] after:border-r-solid after:border-r-[1px] after:border-r-[#C5F60166] after:border-t-solid after:border-t-[1px] after:border-t-[#C5F60166] 
                    sm:scale-[0.5] sm:top-[192px] sm:-right-[80px] md:scale-[0.7] md:top-[100px] md:-right-[40px] md:top-[195px] lg:right-[45px] lg:scale-[0.8] lg:top-[210px] lg:-rotate-[10deg] xl:right-[55px] xl:top-[250px] xl:-rotate-[8deg] xl:scale-[1] 2xl:right-[150px] 2xl:-rotate-[13deg] 2xl:top-[255px]">
                        <div class="producting w-[80px] h-[80px] overflow-hidden rounded-[15px]">
                            <img src={saree} alt="Product" draggable="false" class="w-[100%] relative z-[6]" />
                        </div>
                        <div class="contenting ml-[15px]">
                    ...
                    <div class="flex justify-start items-center tag-three h-[86px] -rotate-[4deg] rounded-r-none rounded-tl-[15px] rounded-br-[4px] rounded-tr-[4px] rounded-bl-[15px] min-w-[350px] p-[15px] min-h-[100px] absolute z-[5] 
                    before:content-[''] before:absolute before:min-w-[12px] before:min-h-[12px] before:boredr-solid before:border-[1px] before:border-[#D9D9D9] before:rounded-[50px] before:z-[3] before:bg-[#000000] before:-right-[15px]
                    after:content-[''] after:backdrop-blur-[25px] after:absolute after:min-w-[77px] after:min-h-[77px] after:-z-[1] after:-right-[35px] after:rotate-[45deg] after:rounded-t-[11px] after:rounded-r-[10px] after:rounded-b-[11px] after:rounded-l-[0px] after:bg-[#333821] after:border-r-solid after:border-r-[1px] after:border-r-[#C5F60166] after:border-t-solid after:border-t-[1px] after:border-t-[#C5F60166] 
                    sm:scale-[0.3] sm:-left-[105px] sm:top-[360px] md:scale-[0.5] md:top-[410px] md:-left-[80px] lg:scale-[0.7] lg:-left-[15px] lg:top-[430px] xl:-left-[16px] xl:scale-[0.9] xl:top-[520px] 2xl:scale[1] 2xl:left-[40px] 2xl:top-[588px] ">
                        <div class="producting w-[80px] h-[80px] overflow-hidden rounded-[15px]">
                            <img src={saree} alt="Product" draggable="false" class="w-[100%] relative z-[6]" />
                        </div>
                        <div class="contenting ml-[15px]">
                    ...
                    <div class="flex justify-start items-center tag-four h-[86px] rotate-[5deg] rounded-l-none rounded-tl-[4px] rounded-br-[15px] rounded-tr-[15px] rounded-bl-[4px] min-w-[350px] p-[15px] min-h-[100px] absolute z-[5] 
                    before:content-[''] before:absolute before:min-w-[12px] before:min-h-[12px] before:boredr-solid before:border-[1px] before:border-[#D9D9D9] before:rounded-[50px] before:z-[3] before:bg-[#000000] before:-left-[15px]
                    after:content-[''] after:backdrop-blur-[25px] after:absolute after:min-w-[77px] after:min-h-[77px] after:-z-[1] after:-left-[37px] after:-rotate-[45deg] after:bg-[#627912] after:rounded-t-[10px] after:rounded-r-[11px] after:rounded-b-[10px] after:rounded-l-[11px] after:border-t-solid after:border-t-[1px] after:border-t-[#C5F60166] after:border-l-solid after:border-l-[1px] after:border-l-[#C5F60166]
                    sm:scale-[0.3] sm:-right-[100px] sm:top-[325px] md:scale-[0.5] md:top-[355px] md:-right-[75px] lg:scale-[0.7] lg:-right-[10px] lg:top-[360px] xl:scale-[0.9] xl:-right-[10px] xl:top-[430px] 2xl:scale-[1] 2xl:right-[5px] 2xl:top-[490px]">
                        <div class="producting w-[80px] h-[80px] overflow-hidden rounded-[15px]">
                            <img src={saree} alt="Product" draggable="false" class="w-[100%] relative z-[6]" />
                        </div>
                        <div class="contenting ml-[15px]">
